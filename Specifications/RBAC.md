...
| Connexion                             | V        | X      | V           | V              |
| Déconnexion                           | X        | V      | V           | V              |
| Consulter la liste des joueurs        | V        | V      | V           | V              |
| Proposer des musiques                 | X        | V      | V           | V              |
| Consulter les musiques                | V        | V      | V           | V              |
| Consulter les playlists               | V        | V      | V           | V              |
| Créer une playlist                    | X        | V      | V           | V              |
| Modifier une playlist                 | X        | V      | V           | V              |
| Supprimer une playlist                | X        | V      | V           | V              |
